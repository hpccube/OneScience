...
def onescience_geometry_interpolator(
    mesh: pv.PolyData, onescience_geometry, num_samples: int
) -> Dict[str, np.ndarray]:
    """
    Interpolate mesh results on the boundary of a onescience geometry object

    Args:
        mesh (pv.PolyData): Input mesh
        onescience_geometry : onescience Geometry
...
def onescience_geometry_interior_interpolator(
    mesh: pv.PolyData, onescience_geometry, num_samples: int
) -> Dict[str, np.ndarray]:
    """
    Interpolate mesh results in the interior of a onescience geometry object
