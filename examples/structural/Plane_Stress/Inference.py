...
# σx 云图
plt.subplot(233)
plt.imshow(sx_masked, origin='lower', extent=[0, 1, 0, 1], cmap='jet', vmin=-0.02, vmax=1.42)
...
# σy 云图
plt.subplot(234)
plt.imshow(sy_masked, origin='lower', extent=[0, 1, 0, 1], cmap='jet', vmin=-0.56, vmax=0.32)
plt.colorbar(label='Stress (MPa)')
plt.plot(hole_x, hole_y, 'w-', lw=1)
plt.xlim(0, 1)
plt.ylim(0, 1)
...
# τxy 云图
plt.subplot(235)
plt.imshow(sxy_masked, origin='lower', extent=[0, 1, 0, 1], cmap='jet', vmin=-0.38, vmax=0.34)
