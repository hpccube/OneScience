"""STATE embedding inference orchestration used by the biosciences example."""
...
from onescience.models.state.embedding.model import StateEmbeddingModel
...
class Inference:
    ...
    def load_model(self, checkpoint):
        ...
        import onescience.models.state.embedding.model as legacy_model
        import onescience.modules.loss.stateloss as legacy_loss
        import onescience.modules.transformer.statetransformer as legacy_flash
        ...
        legacy_root = sys.modules["onescience.models.state.embedding"]
        legacy_nn = types.ModuleType("vci.nn")
        legacy_state = types.ModuleType("onescience.modules.state")
        legacy_state.__path__ = []
        legacy_embedding = types.ModuleType("onescience.modules.state.embedding")
        legacy_embedding.__path__ = []
        ...
        legacy_trainer = types.ModuleType("vci.train.trainer")
        ...
        sys.modules["onescience.modules.state"] = legacy_state
        sys.modules["onescience.modules.state.embedding"] = legacy_embedding
        sys.modules["onescience.modules.state.embedding.model"] = legacy_model
        sys.modules["onescience.modules.state.embedding.loss"] = legacy_loss
        sys.modules["onescience.modules.state.embedding.flash_transformer"] = legacy_flash
        ...
        legacy_state.embedding = legacy_embedding
        legacy_embedding.model = legacy_model
        legacy_embedding.loss = legacy_loss
        legacy_embedding.flash_transformer = legacy_flash
