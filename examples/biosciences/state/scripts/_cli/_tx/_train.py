"""STATE transition training command."""
...
def run_tx_train(cfg):
    ...
    from onescience.models.state.transition.factory import get_lightning_module
    ...
    if checkpoint_path is None and manual_init is not None:
        ...
        if pert_encoder_weight_key in checkpoint_state:
            ...
            if checkpoint_pert_dim != model.pert_dim or cfg["data"]["kwargs"]["embed_key"] == "X_hvg":
                ...
                from onescience.models.state.transition.implementations.utils import build_mlp
