...
runtime_model_dir="${STATE_OUTPUT_ROOT}/st_se_replogle/runtime_models/${split_mode}/${cell_line}"
...
for artifact in checkpoints var_dims.pkl pert_onehot_map.pt batch_onehot_map.pkl cell_type_onehot_map.pkl; do
