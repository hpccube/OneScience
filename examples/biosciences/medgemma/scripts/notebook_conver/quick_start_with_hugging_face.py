...
def main():
    parser = argparse.ArgumentParser(description="Quick start MedGemma local Hugging Face inference.")
    ...
    print(response)
    write_outputs(args.output_dir, "quick_start_with_hugging_face", vars(args) | {"response": response})
