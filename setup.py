...
extras["bio"].append("nemo-toolkit @ file://" + \
                    os.path.abspath('./src/onescience/models/evo2/3rdparty/NeMo'))
extras["bio"].append("megatron-core @ file://" + \
                    os.path.abspath('./src/onescience/models/evo2/3rdparty/Megatron-LM'))
extras["bio"].append("noodles @ file://" + \
                    os.path.abspath('./src/onescience/models/evo2/3rdparty/noodles'))
