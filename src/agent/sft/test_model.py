...
model_path_base = '/work/home/onescience2025/.cache/modelscope/hub/Qwen/Qwen2.5-7B-Instruct'
...
pipe = pipeline("text-generation", model=choose_model, trust_remote_code=True,device = 'cuda')
out = pipe(
    messages,
