...
from onescience.datapipes.materials.mattergen.types import PropertySourceId, TargetProperty
from onescience.models.mattergen.common.utils.data_utils import get_atomic_number
from onescience.models.mattergen.common.utils.globals import MAX_ATOMIC_NUM, PROPERTY_SOURCE_IDS
...
class SetUnconditionalEmbeddingType:
    ...
    in onescience.modules.embedding.mattergen_property_embeddings.PropertyEmbedding.forward.
