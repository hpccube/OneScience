...
from onescience.modules.loss.boltzdiffusionloss import (
    smooth_lddt_loss,
)
from onescience.utils.boltz.geometry import weighted_rigid_align
from onescience.modules.diffusion.boltzatomconditioning import (
...
from onescience.modules.transformer.boltztransformer import (
    ConditionedTransitionBlock,
    DiffusionTransformer,
)
from onescience.modules.linear.boltzlinear import LinearNoBias
from onescience.utils.boltz.model import (
    compute_random_augmentation,
    center_random_augmentation,
    default,
    log,
)
from onescience.modules.potential.boltzpotential import get_potentials
...
class AtomDiffusion(Module):
    ...
    def sample(
        ...
        **network_condition_kwargs,
        ...
        if (
            not isinstance(max_parallel_samples, int)
            or isinstance(max_parallel_samples, bool)
            or max_parallel_samples <= 0
        ):
            msg = "max_parallel_samples must be a positive integer"
