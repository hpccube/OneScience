...
from onescience.datapipes.materials.nequip._nl import DEFAULT_NEIGHBORLIST_BACKEND
...
class _IntegrationLoaderMixin:
    ...
    def from_compiled_model(
        ...
        **kwargs,
        ...
        """
        from onescience.models.nequip.model.inference_models import load_compiled_model
