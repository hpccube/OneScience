...
class NequIPCalculator(_IntegrationLoaderMixin, Calculator):
    ...
    def _get_aoti_compile_target(cls) -> Dict:
        from onescience.utils.nequip.cli._compile_utils import COMPILE_TARGET_DICT, AOTI_ASE_TARGET
    ...
    def __init__(
        ...
        **kwargs,
        ...
        from onescience.datapipes.materials.nequip.transforms import NeighborListTransform
        from onescience.datapipes.materials.nequip._nl import NEIGHBORLIST_BACKEND_OPTIONS
