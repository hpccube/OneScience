...
from onescience.datapipes.materials.nequip._nl import NEIGHBORLIST_BACKEND_ALCHEMIOPS
...
class NequIPTorchSimCalc(_IntegrationLoaderMixin, ModelInterface):
    ...
    def _get_aoti_compile_target(cls) -> Dict:
        from onescience.utils.nequip.cli._compile_utils import COMPILE_TARGET_DICT, AOTI_BATCH_TARGET
