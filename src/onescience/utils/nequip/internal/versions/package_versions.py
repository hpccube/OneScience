...
from onescience.models.nequip import _DISCOVERED_NEQUIP_EXTENSION
from onescience.models.nequip._version import __version__ as _nequip_version
...
# NOTE: vendored into OneScience; use the local package version instead of the
# upstream ``nequip`` distribution, which is not installed separately.

_DEFAULT_VERSION_CODES = [torch, e3nn]
...
def get_current_code_versions(verbose: bool = True) -> dict:
    ...
    """
    code_versions = {"nequip": _nequip_version}
