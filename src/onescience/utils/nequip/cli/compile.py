...
from onescience.models.nequip.model.saved_models.load_utils import load_saved_model
from onescience.models.nequip.model.modify_utils import modify
...
from onescience.utils.nequip.internal.versions import _TORCH_GE_2_10
...
def main(args=None):
    ...
    # === TorchScript ===
    if args.mode == "torchscript":
        from onescience.models.nequip.model.inference_models.torchscript import save_torchscript_model
    ...
    if args.mode == "aotinductor":
        ...
        from onescience.utils.nequip.internal.aot import aot_export_model
