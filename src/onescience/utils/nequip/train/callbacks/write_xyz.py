...
from onescience.datapipes.materials.nequip import AtomicDataDict, to_ase
from onescience.datapipes.materials.nequip import (
...
class TestTimeXYZFileWriter(XYZFileWriter):
    ...
    .. code-block:: yaml
        ...
        callbacks:
          - _target_: onescience.utils.nequip.train.callbacks.TestTimeXYZFileWriter
...
class ValTimeXYZFileWriter(XYZFileWriter):
    ...
    .. code-block:: yaml
        ...
        callbacks:
          - _target_: onescience.utils.nequip.train.callbacks.ValTimeXYZFileWriter
