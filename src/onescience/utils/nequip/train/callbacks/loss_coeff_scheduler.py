...
class LossCoefficientScheduler(Callback):
    ...
    .. code-block:: yaml
        ...
        callbacks:
          - _target_: onescience.utils.nequip.train.callbacks.LossCoefficientScheduler
            schedule:
              100:
...
class LinearLossCoefficientScheduler(Callback):
    ...
    .. code-block:: yaml
        ...
        callbacks:
          - _target_: onescience.utils.nequip.train.callbacks.LinearLossCoefficientScheduler
            final_coeffs:
              per_atom_energy_mse: 1.0
              forces_mse: 1.0
              stress_mse: 1.0
