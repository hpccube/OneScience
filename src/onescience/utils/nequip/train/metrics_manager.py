...
from onescience.datapipes.materials.nequip import AtomicDataDict, BaseModifier, PerAtomModifier
from .metrics import (
    MeanSquaredError,
    MeanAbsoluteError,
...
class MetricsManager(torch.nn.ModuleDict):
    ...
    **Weighted Sum**: A ``weighted_sum`` metric is automatically computed when any metric
    ...
    .. code-block:: yaml
        ...
        _target_: onescience.utils.nequip.train.MetricsManager
        metrics:
            - name: per_atom_energy_mse
            field:
                _target_: onescience.datapipes.materials.nequip.PerAtomModifier
                field: total_energy
            coeff: 1
            metric:
                _target_: onescience.utils.nequip.train.MeanSquaredError
            - name: forces_mse
            field: forces
            coeff: 1
            metric:
...
def EnergyForceLoss(
    ...
    .. code-block:: yaml
        ...
        training_module:
          _target_: onescience.utils.nequip.train.NequIPLightningModule
...
def EnergyForceStressLoss(
    ...
    .. code-block:: yaml
        ...
        training_module:
          ...
          loss:
            _target_: onescience.utils.nequip.train.EnergyForceStressLoss
            per_atom_energy: true
            coeffs:
              total_energy: 1.0
              forces: 1.0
...
def EnergyForceStressMetrics(
    ...
    .. code-block:: yaml
        ...
        training_module:
          ...
          val_metrics:
            _target_: onescience.utils.nequip.train.EnergyForceStressMetrics
            coeffs:
              total_energy_rmse: 1.0
              per_atom_energy_rmse: null
              forces_rmse: 1.0
...
def EnergyOnlyLoss(
    ...
    .. code-block:: yaml
        ...
        training_module:
          ...
          loss:
            _target_: onescience.utils.nequip.train.EnergyOnlyLoss
            per_atom_energy: true
...
def EnergyOnlyMetrics(
    ...
    .. code-block:: yaml
        ...
        training_module:
          ...
          val_metrics:
            _target_: onescience.utils.nequip.train.EnergyOnlyMetrics
            coeffs:
              total_energy_rmse: 1.0
              per_atom_energy_rmse: null
              total_energy_mae: null
