...
from onescience.utils.nequip.internal import download_url, extract_zip, extract_tar
...
class rMD17DataModule(NequIPDataModule):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        dataset_config = {
            "_target_": "onescience.datapipes.materials.nequip.dataset.NPZDataset",
            "file_path": file_path,
        ...
        if subset_len is not None:
            dataset_config = {
                "_target_": "onescience.datapipes.materials.nequip.dataset.SubsetByRandomSlice",
