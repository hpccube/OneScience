...
from onescience.datapipes.chai1.data.dataset.structure import utils
...
from onescience.datapipes.chai1.data.dataset.structure.utils import (
...
from onescience.datapipes.chai1.data.parsing.structure.residue import ConformerData, Residue
from onescience.datapipes.chai1.data.residue_constants import standard_residue_pdb_codes
from onescience.datapipes.chai1.data.sources.rdkit import (
    RefConformerGenerator,
    conformer_data_to_rdkit_mol,
)
from onescience.utils.chai1.tensor_utils import string_to_tensorcode, unique_indexes
