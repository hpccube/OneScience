...
from onescience.datapipes.chai1.data.parsing.fasta import get_residue_name, read_fasta
from onescience.datapipes.chai1.data.parsing.glycans import glycan_string_residues
from onescience.datapipes.chai1.data.parsing.input_validation import (
    constituents_of_modified_fasta,
    identify_potential_entity_types,
)
from onescience.datapipes.chai1.data.parsing.structure.all_atom_entity_data import AllAtomEntityData
from onescience.datapipes.chai1.data.parsing.structure.entity_type import EntityType
from onescience.datapipes.chai1.data.parsing.structure.residue import Residue, get_restype
from onescience.datapipes.chai1.data.residue_constants import (
