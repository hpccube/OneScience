...
from onescience.datapipes.chai1.data import residue_constants as rc
from onescience.datapipes.chai1.data.dataset.structure.all_atom_residue_tokenizer import (
    AllAtomResidueTokenizer,
)
from onescience.datapipes.chai1.data.dataset.structure.all_atom_structure_context import (
    AllAtomStructureContext,
)
from onescience.datapipes.chai1.data.dataset.structure.chain import Chain
from onescience.datapipes.chai1.data.dataset.templates.align import align_1d, align_2d
from onescience.datapipes.chai1.data.dataset.templates.load import LoadedTemplate, get_template_data
from onescience.datapipes.chai1.data.parsing.msas.aligned_pqt import hash_sequence
from onescience.datapipes.chai1.data.parsing.structure.entity_type import EntityType
from onescience.datapipes.chai1.data.parsing.templates.m8 import parse_m8_to_template_hits
from onescience.datapipes.chai1.data.parsing.templates.template_hit import TemplateHit
from onescience.datapipes.chai1.data.sources.rdkit import RefConformerGenerator
from onescience.utils.chai1.defaults import default
from onescience.utils.chai1.paths import get_model_dir
from onescience.utils.chai1.typing import Bool, Float, Int, typecheck

logger = logging.getLogger(__name__)

def get_template_cif_folder() -> Path:
    return Path(
        os.environ.get(
            "CHAI_TEMPLATE_CIF_FOLDER", get_model_dir() / "template_cifs"
        )
    )
...
def get_template_context(
    ...
    """
    if template_cif_cache_folder is None:
        template_cif_cache_folder = get_template_cif_folder()
