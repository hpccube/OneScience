...
from onescience.datapipes.chai1.data.dataset.msas.msa_context import NO_PAIRING_KEY
from onescience.datapipes.chai1.data.features.feature_type import FeatureType
from onescience.datapipes.chai1.data.features.generators.base import EncodingType, FeatureGenerator
from onescience.datapipes.chai1.data.parsing.msas.data_source import msa_dataset_source_to_int
from onescience.datapipes.chai1.data.residue_constants import residue_types_with_nucleotides_order
from onescience.utils.chai1.tensor_utils import masked_mean
from onescience.utils.chai1.typing import Bool, Int, UInt8, typecheck
...
class MSADataSourceGenerator(FeatureGenerator):
    ...
    def _generate(
        ...
        from onescience.datapipes.chai1.data.parsing.msas.data_source import MSADataSource
