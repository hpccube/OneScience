...
from onescience.datapipes.boltz.feature.symmetry import (
    minimum_lddt_symmetry_coords,
    minimum_symmetry_coords,
)
from onescience.modules.loss.boltzconfidence import confidence_loss
from onescience.modules.loss.boltzdistogram import distogram_loss
from onescience.metrics.boltz.validation import (
    compute_pae_mae,
    compute_pde_mae,
    compute_plddt_mae,
    factored_lddt_loss,
...
from onescience.modules.head.boltzconfidence import ConfidenceModule
from onescience.modules.diffusion.boltzdiffusion import AtomDiffusion
from onescience.modules.embedding.boltzembedding import InputEmbedder, RelativePositionEncoder
from onescience.modules.head.boltzdistrogram import DistogramModule
from onescience.modules.msa.boltzmsa import MSAModule
from onescience.modules.pairformer.boltzpairformerv1 import PairformerModule
    ...
    def validation_step(self, batch: dict[str, Tensor], batch_idx: int):
        ...
        try:
            out = self(
                ...
                max_parallel_samples=self.validation_args.get(
