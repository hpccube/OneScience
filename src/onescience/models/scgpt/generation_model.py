...
from onescience.utils.scgpt.logging import logger
from onescience.utils.scgpt.util import map_raw_id_to_vocab_id
...
class TransformerGenerator(nn.Module):
    ...
    def forward(
        ...
        if self.n_input_bins > 0:
            from onescience.datapipes.scgpt.preprocess import binning
