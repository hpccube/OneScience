...
from onescience.utils.state.embedding import (
    get_embedding_cfg,
    get_dataset_cfg,
)
from onescience.modules.loss.stateloss import KLDivergenceLoss, MMDLoss, TabularLoss, WassersteinLoss


from onescience.modules.transformer.statetransformer import FlashTransformerEncoder
from onescience.modules.transformer.statetransformer import FlashTransformerEncoderLayer
...
class StateEmbeddingModel(L.LightningModule):
    ...
    def on_save_checkpoint(self, checkpoint):
        ...
        try:
            if self.protein_embeds is not None:
                ...
                from onescience.utils.state.embedding import get_embedding_cfg
    ...
    def shared_step(self, batch, batch_idx):
        ...
        with torch.autocast(device_type="cuda", enabled=False):
            decs = self.binary_decoder(combine.float())
